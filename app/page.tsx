...
function getExternalLinkProps(link: FooterLink) {
  return link.external ? { target: '_blank', rel: 'noreferrer noopener' } : undefined;
}

function normalizeSession(raw: string): SessionId | undefined {
          ...
          <div className="site-footer__columns">
            <div className="site-footer__column">
              ...
              <ul className="site-footer__list">
                {footer.productLinks.map((link: FooterLink) => (
            ...
            <div className="site-footer__column">
              ...
              <ul className="site-footer__list">
                {footer.resourcesLinks.map((link: FooterLink) => (
                  <li key={`${link.href}-${link.label}`} className="site-footer__list-item">
                    <a
                      href={link.href}
                      {...getExternalLinkProps(link)}
            ...
            <div className="site-footer__column">
              ...
              <ul className="site-footer__list">
                {footer.supportLinks.map((link: FooterLink) => (
                  <li key={`${link.href}-${link.label}`} className="site-footer__list-item">
                    <a
                      href={link.href}
                      {...getExternalLinkProps(link)}
