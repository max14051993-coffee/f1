...
const CIRCUIT_ALIASES: Record<string, string> = {
  ...
  'circuito-de-jerez-angel-nieto': 'circuito-de-jerez-angel-nieto',
  ...
  'balaton-park': 'balaton-park',
  'mobility-resort-motegi': 'mobility-resort-motegi',
  'pertamina-mandalika-circuit': 'mandalika-international-street-circuit',
  'mandalika-international-street-circuit': 'mandalika-international-street-circuit',
  'phillip-island': 'phillip-island',
  'autodromo-internacional-do-algarve': 'autodromo-internacional-do-algarve',
